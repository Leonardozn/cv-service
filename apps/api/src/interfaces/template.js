...
class TemplateInterfaces {
	...
	constructor() {
		...
		this.updateInterface = this.dataValidatorHandler.validate({
			...
			key: { type: this.types.string, optional: true },
			description: { type: this.types.string, optional: true },
		...
		this.queryInterface = this.dataValidatorHandler.validate({
			...
			key: { type: this.types.string, optional: true, transform: true, allowAdvance: true },
		...
		this.virtualsInterface = this.dataValidatorHandler.validate({
			...
			key: { type: this.types.string, optional: true, isVirtual: true },
	...
	static getInstance() {
		if (!this.instance) this.instance = new TemplateInterfaces()
...
module.exports = TemplateInterfaces